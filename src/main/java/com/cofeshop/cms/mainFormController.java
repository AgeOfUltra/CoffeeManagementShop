...
import com.cofeshop.cms.datamodel.customersData;
import com.cofeshop.cms.datamodel.data;
import com.cofeshop.cms.datamodel.productData;
...
//        menu_tableView.setItems(menuOrderListData);
//
//        // Bind the items in the TableView to your ObservableList
//        menu_tableView.itemsProperty().bindBidirectional(menuOrderListData.stream().sorted());
//}

//    public void menuShowOrderData() {
//      menuOrderListData = menuGetOrder();
//
//      // Create bindings for cell value factories
//      menu_col_productName.setCellValueFactory(cellData -> EasyBind.map(cellData.getValue(),Order::));
//      menu_col_quantity.setCellValueFactory(cellData -> EasyBind.map(cellData.getValue(), Order::getQuantity));
//      menu_col_price.setCellValueFactory(cellData -> EasyBind.map(cellData.getValue(), Order::getPrice));
//
//      menu_tableView.setItems(menuOrderListData);
//    }
    ...
    public void menuAmount() {
        ...
        if (menu_amount.getText().isEmpty() || totalP == 0) {
            ...
            alert.setTitle("Error Message");
            alert.setHeaderText(null);
            alert.setContentText("Invalid : amount to pay");
            alert.showAndWait();
        } else {
        ...
        if (totalP == 0) {
            ...
            try {
                ...
                if (amount == 0) {
                    ...
                    alert.setHeaderText(null);
                    alert.setContentText("Something wrong : enter valid money ");
                    alert.showAndWait();
                    ...
                    alert.setHeaderText(null);
                    alert.setContentText("Are you sure to pay : "+amount+" ?");
                    Optional<ButtonType> option = alert.showAndWait();
...
//            try {
//
//                JasperDesign jDesign = JRXmlLoader.load("C:\\Users\\sarad\\Desktop\\Projects\\cms\\src\\main\\java\\com\\cafeshopmanagementsystem\\cms\\report.jrxml");
